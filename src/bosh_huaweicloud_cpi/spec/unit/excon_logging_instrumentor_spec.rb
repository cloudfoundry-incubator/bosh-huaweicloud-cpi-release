...
describe Bosh::HuaweiCloud::ExconLoggingInstrumentor do
  describe '.instrument' do
    let(:name) { 'foo' }
    let(:params) { { foo: 'bar' } }
    let(:logger) { instance_double('Logger') }

    subject { Bosh::HuaweiCloud::ExconLoggingInstrumentor }
    ...
    it 'yields' do
      expect { |b| Bosh::HuaweiCloud::ExconLoggingInstrumentor.instrument(name, params, &b) }.to yield_control
    end
