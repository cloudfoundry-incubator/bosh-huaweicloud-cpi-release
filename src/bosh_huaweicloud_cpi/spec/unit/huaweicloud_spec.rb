...
describe Bosh::HuaweiCloud::Huawei do
  ...
  describe 'is_v3' do
    it 'should identify keystone v3 URIs' do
      expect(Bosh::HuaweiCloud::Huawei.is_v3('http://fake-auth-url/v3')).to be_truthy
    end
    ...
    describe (fog[:name]).to_s do
      ...
      context 'with connection options' do
        ...
        let(:default_connection_options) {
          { 'instrumentor' => Bosh::HuaweiCloud::ExconLoggingInstrumentor }
        }
      ...
      context 'when last retry succeeds' do
        before do
          ...
          allow(fog[:clazz]).to receive(:new) do
            retry_count += 1
            if retry_count < Bosh::HuaweiCloud::Cloud::CONNECT_RETRY_COUNT
