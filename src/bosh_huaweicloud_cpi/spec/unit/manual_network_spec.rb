...
describe Bosh::HuaweiCloud::ManualNetwork do
  ...
  describe '#prepare' do
    ...
    context "with 'use_nova_networking=false'" do
      ...
      let(:ports) { double('Fog::Network::HuaweiCloud::Ports') }
    ...
    context "with 'use_nova_networking=true'" do
      ...
      let(:openstack) { instance_double(Bosh::HuaweiCloud::Huawei, use_nova_networking?: true, network: double('Fog::Network')) }
  ...
  describe '#cleanup' do
    ...
    context "with 'use_nova_networking=false'" do
      ...
      let(:neutron) { double(Fog::Network) }
      let(:openstack) { instance_double(Bosh::HuaweiCloud::Huawei, use_nova_networking?: false, network: double('Fog::Network')) }
      let(:ports) { double('Fog::Network::HuaweiCloud::Ports') }
